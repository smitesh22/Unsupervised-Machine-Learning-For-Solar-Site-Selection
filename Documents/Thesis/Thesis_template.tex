...
\begin{document}
	...
	They employed a hybrid model combining a \ac{MLP} and an Autoencoder. It comprises of an encoder and a decoder, which collaboratively work to diminish the dimensionality of the input vector, 
